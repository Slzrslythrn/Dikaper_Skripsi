        ...
        <section id="services" class="services section-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row"> 
                    ...
                    <div class=" col-md-2 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
                        data-aos-delay="100">
                        <div class="icon-box">
                            <h4><a href="">Kelurahan</a></h4>
                            <p>Kelurahan Menerbitkan Surat keterangan tidak mampu (SKTM)
                            </p>
                        </div>
                    </div>
            ...
            <div class="container" data-aos="zoom-in">
                ...
                <div class="row">
                    <div class="col-lg-12 text-center text-lg-start">
                        <center><h3>Dikaper Kota Bogor</h3>
                        <p> Jaminan Kesehatan Daerah yang selanjutnya disebut Jamkesda adalah sistem jaminan kesehatan
                            yang pembiayaannya, pengorganisasian dan pelayanan kesehatannya ditetapkan oleh Pemerintah daerah.
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="faq-list">
                    <ul>
                        ...
                        <li data-aos="fade-up" data-aos-delay="100">
                            <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">5. Bukti
                                pendaftaran BPJS Kesehatan Kelas 3</a>

                        </li>
                        
                        <li data-aos="fade-up" data-aos-delay="100">
                            <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">6. Pada kasus
                                kekerasan dilampirkan laporan/surat kepolisian.</a>
                        </li>
                        <li data-aos="fade-up" data-aos-delay="100">
                            <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">7. Korban
                                bencana dilampirkan surat keterangan dari kelurahan.</a>
                        </li>
                        <li data-aos="fade-up" data-aos-delay="100">
                            <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">8. Pada kasus
