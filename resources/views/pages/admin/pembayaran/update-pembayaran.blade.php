<x-app-layout>
                                ...
                                <form class="needs-validation" novalidate=""
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="tarif_inacbgs" name="tarif_inacbgs" required disabled>
                                                <option value="">Pilih Tarif</option>
                                            </select>
                                            {{-- Tambahkan hidden input di sini --}}
                                            <input type="hidden" name="nilai_tarif_inacbgs" id="nilai_tarif_inacbgs">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="biaya_lainnya" id="biaya_lainnya"
                                                ...
                                                value=" {{$pembayaran->biaya_lainnya}}" onkeyup="formatRupiah(this)">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="total_biaya" id="total_biaya"
                                                ...
                                                value=" {{ $pembayaran->total_biaya}}" onkeyup="formatRupiah(this)">
                                    ...
                                    <div class="mb-3">
                                        <label for="username">Berkas Pasien Pulang - Type File <span
    ...
    <script>
        ...
        $('#diagnosa').html('<option value="">Memuat...</option>'); // Menampilkan loading
            if (jenis_rs) {
            $.ajax({
                ...
                success: function(data) {
                    $('#diagnosa').html(''); // Kosongkan opsi sebelumnya
                    if (data.length > 0) {
                        ...
                        $('#diagnosa').append('<option value="">Tidak ada diagnosa</option>');
                    }
                },
                error: function() {
                    $('#diagnosa').html('<option value="">Error memuat diagnosa</option>');
                }
            });
            }
        });
        ...
        if (id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#nilai_tarif_inacbgs').val(data.tarif); // simpan ke input hidden
                    hitungTotalBiaya();
                }
            });
            }
...
function hitungTotalBiaya() {
    let tarifInacbgs = parseRupiahToNumber($('#nilai_tarif_inacbgs').val());
    let tarifRs = parseRupiahToNumber($('#tarif_rs').val());
    let biayaLainnya = parseRupiahToNumber($('#biaya_lainnya').val());

    let total = tarifInacbgs + tarifRs + biayaLainnya;

    $('#total_biaya').val(total.toLocaleString('id-ID'));
}

// Trigger hitung ulang ketika input berubah
$('#tarif_rs, #biaya_lainnya').on('keyup change', function() {
    hitungTotalBiaya();
});
</script>
