<x-app-layout>
        ...
        if (id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#nilai_tarif_inacbgs').val(data.tarif); // simpan nilai ke hidden input
                 hitungTotalBiaya();
                }
            });
        }
    ...
    function hitungTotalBiaya() {
        ...
        $('#total_biaya').val(total.toLocaleString('id-ID')); // ditampilkan dalam format ribuan
    }

    $(document).ready(function () {
        $('#tarif_rs, #biaya_lainnya').on('input', function () {
            hitungTotalBiaya();
        });

        $('#tarif_inacbgs').on('change', function () {
            $('#nilai_tarif_inacbgs').val($(this).val());
            hitungTotalBiaya();
        });
    });
</script>
