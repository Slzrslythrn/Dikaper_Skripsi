<x-app-layout>
                                ...
                                <table class="table table-sm mb-0" id="example">
                                    ...
                                    <tbody id="orders">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($row->pembayaran)
                                                {{ $row->pembayaranInacbgs->inacbgs->jenis_rs }}
                                                @endif
                                            </td>

                                            <td>
                                                @if ($row->pembayaran)
                                                {{ $row->pembayaranInacbgs->inacbgs->deskrpsi }}
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                @if ($row->pembayaran)
                                                {{ $row->pembayaran->biaya_lainnya }}
                                                @endif
                                            </td>

                                            <td>
                                                @if ($row->pembayaran)
                                                {{ $row->pembayaran->total_biaya}}
                                                @endif
                                            </td> 
    ...
    @push('after-scripts')
        ...
        <script>
            (function($) {
                "use strict"
                // Initialize DataTable with show entries and search features
...
function hitungTotalBiaya() {
    let tarifInacbgs = parseFloat($('#tarif_inacbgs').val()) || 0;
    let tarifRs = parseFloat($('#tarif_rs').val()) || 0;
    let biayaLainnya = parseFloat($('#biaya_lainnya').val()) || 0;
...
$(document).ready(function () {
    $('#tarif_inacbgs, #tarif_rs, #biaya_lainnya').on('input', function () {
        hitungTotalBiaya();
    });
});
</script>
