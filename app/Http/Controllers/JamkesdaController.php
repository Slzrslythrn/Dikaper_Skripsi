...
class JamkesdaController extends Controller
{
    ...
    public function prosesDiKembalikan(Request $request)
    {
        ...
        Alert::info('Pengajuan Dikembalikan');
        return redirect()->route('jamkesda');
    }
...
public function downloadDiterima($encrypted_id)
{
    ...
    // Hapus data lama di pembayaran_inacbgs
    PembayaranInacbgs::where('pasien_id', $pasien_id)->delete();
    // Tambahkan data baru ke pembayaran_inacbgs
    PembayaranInacbgs::create([
        'pasien_id' => $pasien_id,
